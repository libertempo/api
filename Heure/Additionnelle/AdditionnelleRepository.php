...
namespace LibertAPI\Heure\Additionnelle;
 ...
 */
class AdditionnelleRepository extends \LibertAPI\Tools\Libraries\ARepository
{
    final protected function getEntiteClass() : string
    {
        return AdditionnelleEntite::class;
    }
