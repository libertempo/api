...
use \LibertAPI\Components\Planning\Repository as _Repository;
...
{
    /**
     * @var \LibertAPI\Components\Planning\Dao Mock du DAO du planning
     */
    private $dao;

    /**
     * @var \LibertAPI\Components\Planning\Entite Mock de l'Entité de planning
     */
    private $entite;
    ...
    public function beforeTestMethod($method)
    {
        ...
        $this->dao = new \mock\LibertAPI\Components\Planning\Dao();
        $this->mockGenerator->orphanize('__construct');
        $this->entite = new \mock\LibertAPI\Components\Planning\Entite();
    ...
    public function testPostOneMissingArg()
    {
        ...
        $this->exception(function () use ($repository) {
            $repository->postOne(['name' => 'bob'], new \mock\LibertAPI\Components\Planning\Entite([]));
    ...
    {
        $repository = new _Repository($this->dao);
        $entite = new \mock\LibertAPI\Components\Planning\Entite([]);
    ...
    public function testPutOneMissingArgument()
    {
        ...
        $this->exception(function () use ($repository) {
            $repository->putOne(['name' => 'bob'], new \mock\LibertAPI\Components\Planning\Entite([]));
        })->isInstanceOf('\LibertAPI\Tools\Exceptions\MissingArgumentException');
    }
    ...
    public function testDeleteFallback()
    {
        ...
        $this->exception(function () use ($repository) {
            $repository->deleteOne(new \mock\LibertAPI\Components\Planning\Entite([]));
